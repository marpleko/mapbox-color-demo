...
import MapboxBasemapVisibility from '../utils/MapboxBasemapVisibility';
...
const map = ref(null);
const mapboxBasemapVisibility = new MapboxBasemapVisibility({
  styles: styles
});
...
onMounted(async () => {
  ...
  map.value = await mapboxBasemapVisibility.createMap({

...
<button @click="resetLocation">
  Reset
    ...
    <!-- <Map :modelValue="location" :mapStyle="styles[mapStyle]" :selectedLayers="selectedLayers"
      :layerTransparency="layerTransparency" @update:modelValue="updateLocation" /> -->
  </div>
</template>

<script setup>
import { ref, onMounted } from 'vue';
import Map from '../maps/MaintainLayerDemoMap.vue';
...
const updateMapTransparency = (layerKey, transparency) => {
  ...
  layerTransparency.value[layerKey] = (100 - transparency).toString();
}
